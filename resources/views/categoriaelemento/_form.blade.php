@php
    ...
    $val = fn($key, $default = '') => old($key, isset($categoriaelemento) ? ($categoriaelemento->{$key} ?? $default) : $default);
@endphp
...
<div class="space-y-4">
    ...
    <div>
            <label class="block text-sm font-medium mb-1">Descripcion del elemento</label>
